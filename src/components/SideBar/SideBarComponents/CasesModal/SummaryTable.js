  ...
  return (
    ...
    >
      <p className={classes.summary} id="uploadCaseSetSummaryCount">
        {`${matchedContent.length + unmatchedContent.length} submitted unique Subject ID(s) mapped to ${matchedContent.length} unique GMB Subject IDs`}
      </p>
          ...
          matchedContent.length ? (
            <table className={classes.tableContainer} id="uploadCaseSetMatchedTable">
              <tr id="uploadCaseSetMatchedHeader">
                <th className={classes.header}>SUBMITTED SUBJECT ID</th>
          ...
          : (
            unmatchedContent.length ? (
              <table className={classes.tableContainer} id="uploadCaseSetUnMatchedTable">
                <th id="uploadCaseSetUnMatchedHeader" className={classes.heading} style={{ textAlign: 'left', paddingLeft: 50 }}>SUBMITTED SUBJECT ID</th>
